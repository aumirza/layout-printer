    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted flex flex-col items-center justify-center p-4">
      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-xl mb-8 text-muted-foreground max-w-2xl mx-auto">
          Create beautiful photo collages perfect for printing. Arrange your
          photos in a grid, customize layouts, and export in high resolution for
          printing.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-card p-6 rounded-lg shadow-md">
            ...
            <p className="text-muted-foreground text-sm">
              Drag and drop your photos into the collage maker and easily
              organize them.
            </p>
          </div>
          ...
          <div className="bg-card p-6 rounded-lg shadow-md">
            ...
            <p className="text-muted-foreground text-sm">
              Choose from standard page sizes and photo dimensions or create
          ...
          <div className="bg-card p-6 rounded-lg shadow-md">
            ...
            <p className="text-muted-foreground text-sm">
              Export high-quality PDFs and images or send directly to your
              printer.
            </p>
          </div>
        </div>
      ...
      <footer className="mt-24 text-center text-muted-foreground text-sm">
        <p>
          &copy; {new Date().getFullYear()} Photo Collage Maker. All rights
          reserved.
        </p>
      </footer>
    </div>
